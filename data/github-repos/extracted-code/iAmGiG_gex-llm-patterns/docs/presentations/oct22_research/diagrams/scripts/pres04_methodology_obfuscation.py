...
before_colors = [removed_color, removed_color,
                 removed_color, kept_color, kept_color]
...
ax1.text(0.5, 4.3, "✓\nKEPT", ha='center', va='center',
         fontsize=16, fontweight='bold', color='#006400')
...
after_colors = [removed_color, removed_color,
                removed_color, kept_color, kept_color]
...
fig.text(0.5, 0.5, "→", ha='center', va='center',
         fontsize=100, fontweight='bold', color='#003366')

# Main title
fig.suptitle('Obfuscation Testing: Isolating Structural Pattern Detection',
...
fig.text(0.5, 0.02, result,
         ha='center', fontsize=20, fontweight='bold', color='#006400')
