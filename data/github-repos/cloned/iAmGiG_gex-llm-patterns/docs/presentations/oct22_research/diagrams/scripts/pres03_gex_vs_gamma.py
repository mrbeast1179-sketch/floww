...
# Main title
fig.text(0.5, 0.95, 'GEX ≠ Gamma (The Greek)',
         ha='center', fontsize=32, fontweight='bold')

# Subtitle
fig.text(0.5, 0.90, 'Understanding the critical distinction',
...
# Header
left_header = FancyBboxPatch((0.75, 7.5), col_width, 0.6,
...
ax.text(left_x, 7.75, 'Gamma (Γ) - The Greek',
        ha='center', fontsize=24, fontweight='bold', color='#003366', zorder=4)

# Content box
left_box = FancyBboxPatch((0.75, 2.0), col_width, 5.2,
                          boxstyle="round,pad=0.1",
                          facecolor='#f5f5f5',
                          edgecolor='#000000',
                          linewidth=3,
...
ax.text(left_x, 4.5, gamma_text,
        ha='center', va='center', fontsize=17,
        color='#000000', zorder=4, linespacing=1.6)

# Small circle visual
small_circle = Circle((left_x, 8.6), 0.3,
                      facecolor='#003366', edgecolor='#000000',
                      linewidth=2, alpha=0.7, zorder=3)
ax.add_patch(small_circle)
ax.text(left_x, 8.6, 'γ',
...
arrow = FancyArrowPatch((6.5, 4.5), (9.5, 4.5),
...
# Header
right_header = FancyBboxPatch((9.75, 7.5), col_width, 0.6,
                              boxstyle="round,pad=0.1",
                              facecolor='#FFE5B4',
                              edgecolor='#8B0000',
                              linewidth=4,
...
ax.text(right_x, 7.75, 'GEX - Gamma Exposure',
        ha='center', fontsize=24, fontweight='bold', color='#8B0000', zorder=4)

# Content box
right_box = FancyBboxPatch((9.75, 2.0), col_width, 5.2,
                           boxstyle="round,pad=0.1",
                           facecolor='#fff8e6',
                           edgecolor='#000000',
                           linewidth=3,
...
ax.text(right_x, 4.6, gex_text,
        ha='center', va='center', fontsize=17,
        color='#8B0000', fontweight='bold', zorder=4, linespacing=1.6)

# Large circle visual
large_circle = Circle((right_x, 8.62), 0.37,
                      facecolor='#8B0000', edgecolor='#000000',
                      linewidth=2, alpha=0.7, zorder=3)
ax.add_patch(large_circle)
ax.text(right_x, 8.62, 'GEX',
        ha='center', va='center', fontsize=20,
        color='white', fontweight='bold', zorder=4)
