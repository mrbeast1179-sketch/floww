...
We focus exclusively on SPY for three reasons: (1) maximal dealer hedging observability in the world's most liquid options market, (2) data quality advantages (tightest spreads, complete strike coverage), and (3) methodological conservatism—detecting patterns in the most efficient market provides stronger evidence than detection in thinly traded underlyings where noise dominates. SPY also serves as the primary 0DTE options vehicle, making it the natural testbed for same-day expiration patterns.
