...
The large effect size ($\phi = 0.672$) and temporal coincidence with 0DTE proliferation (2020 <5\% volume share, 2023 43\% volume share, 2024 $\approx$48\%~\cite{cboe2024zero}) are consistent with mechanistic interpretation.
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{../figures/output/fig07_confidence_discrimination.png}
