# Round 11 — Hermes Agent 08  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **08**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-08  (P3) <<<
- **Your branch (create from main, once):** `round11/agent-08-hub`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/agentfield_hub.py
