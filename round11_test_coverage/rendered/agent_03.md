# Round 11 — Hermes Agent 03  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **03**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-03  (P1 (trading-critical)) <<<
- **Your branch (create from main, once):** `round11/agent-03-mlfeat`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/ml_realtime_features.py
