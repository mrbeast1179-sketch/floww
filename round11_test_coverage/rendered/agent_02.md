# Round 11 — Hermes Agent 02  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **02**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-02  (P1 (trading-critical)) <<<
- **Your branch (create from main, once):** `round11/agent-02-alerts`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/alert_dispatcher.py, services/audit_trail.py
