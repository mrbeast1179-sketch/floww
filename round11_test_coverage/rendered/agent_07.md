# Round 11 — Hermes Agent 07  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **07**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-07  (P3) <<<
- **Your branch (create from main, once):** `round11/agent-07-kanban`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/kanban/throughput_model.py, services/kanban/multi_repo.py
