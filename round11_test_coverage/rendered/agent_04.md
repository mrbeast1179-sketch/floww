# Round 11 — Hermes Agent 04  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **04**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-04  (P1 (trading-critical)) <<<
- **Your branch (create from main, once):** `round11/agent-04-mlinfra`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/ml/health_monitor.py, services/ml/gex_inference.py
