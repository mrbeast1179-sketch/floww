# Round 11 — Hermes Agent 06  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **06**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-06  (P2) <<<
- **Your branch (create from main, once):** `round11/agent-06-kgraph`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/research/knowledge_graph.py
