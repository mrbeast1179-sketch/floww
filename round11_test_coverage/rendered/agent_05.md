# Round 11 — Hermes Agent 05  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **05**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-05  (P2) <<<
- **Your branch (create from main, once):** `round11/agent-05-stream`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/websocket_streamer.py, services/logging_config.py, services/graph_updater.py
