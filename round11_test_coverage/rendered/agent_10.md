# Round 11 — Hermes Agent 10  (FULL SELF-CONTAINED PROMPT)

You are Hermes test-coverage agent **10**. Everything you need is in this one message. Do NOT improvise beyond it.
...
## >>> YOUR LANE — agent-10  (P2) <<<
- **Your branch (create from main, once):** `round11/agent-10-causal`
- **Your services** (write `tests/.../test_<name>.py` for EACH): services/causal/ate_estimator.py, services/backtest/report.py, services/backtest/retail_flow_signal.py
